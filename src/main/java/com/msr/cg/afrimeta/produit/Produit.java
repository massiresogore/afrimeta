...
public class Produit {
    ...
    public Produit(Long produitId, String tite, String description, int quantite_stock, String image_url, double prix, LocalDate dateAjout, Categorie categorie, TypeProduit typeProduit, Website website) {
    ...
    public @Length(max = 100, min = 5) String getTite() {
        return tite;
    }

    public void setTite(@Length(max = 100, min = 5) String tite) {
        this.tite = tite;
    }
    ...
    public void setPrix(@DecimalMin("0.5") @DecimalMax("") double prix) {
        this.prix = prix;
    }
